...
//    entity getSalesProductionOrder as projection on od.SALES_PROD_ORD;
   ...
   entity getAppDetails as projection on od.APPLICATION_DETAILS;
    ...
    function maintainUserPreferences(FLAG: String(1), PREFERENCEDATA: String)                                                                                                                                                                                                                                                            returns String;
    ...
    function getForecastCIRTel(LOCATION_ID: String(4), PLANNING_LOC: String, PRODUCT_ID: String(40), VERSION: String(10), SCENARIO: String(32), FROMDATE: Date, TODATE: Date, MODEL_VERSION: String(20), UNIQUE_ID: String, weekType: String)                                                                                            returns String;
 ...
 */
   ...
   function getPlannedOptionPercentagenew(LOCATION_ID: String(4), PRODUCT_ID: String, FROM_DATE: Date, TO_DATE: Date, MODEL_VERSION: String(20), VERSION: String(10), SCENARIO: String(32))                                                                                                                                                returns String;
    ...
    function updateCalenderWeek(CalendarData: LargeString)                                                                                                                                                                                                                                                                               returns String;
